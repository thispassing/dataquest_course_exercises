...
sql_pattern = r"(\w+SQL)"
hn_sql['flavor'] = hn_sql['title'].str.extract(sql_pattern, re.I)
...
versions = titles.str.extract(pattern, flags=re.I)
...
top_domains = domains.value_counts(ascending=False).head(20)
