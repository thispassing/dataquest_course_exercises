...
merged = merged.rename(mapper=col_renaming, axis=1)
...
merged['national_accounts'] = national_accounts
national_accounts_df = merged[merged['national_accounts'] == True]
...
has_year_bool = merged['SpecialNotes'].str.contains(pattern, na=False)
has_year = merged[has_year_bool]
